...
public class AnimationHandler 
{
	public static void AnimationStart()
	{
		...
		{
			animatedChalk(1, MainActivity.rectangle1[1].getX(), MainActivity.rectangle1[1].getY(),
		...
		{
			animatedChalk(1, MainActivity.rectangle1[9].getX(), MainActivity.rectangle1[9].getY(),
		...
		{
			animatedChalk(1, MainActivity.rectangle1[17].getX()+10, MainActivity.rectangle1[17].getY(),
		...
		{
			animatedChalk(1, MainActivity.rectangle1[20].getX()+5, MainActivity.rectangle1[20].getY()+10,
		...
		{
			animatedChalk(1, MainActivity.rectangle1[24].getX(), MainActivity.rectangle1[24].getY()+20,
		...
		{
			animatedChalk(1, MainActivity.rectangle1[29].getX(), MainActivity.rectangle1[29].getY()+20,
		...
		{
			animatedChalk(1, MainActivity.rectangle1[32].getX(), MainActivity.rectangle1[32].getY()+20,
	...
	public static void animatedChalk(int a, float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4,
			...
			float x10, float y10)
	{
		...
		MainActivity.pieceChalk.registerEntityModifier(new LoopEntityModifier(new PathModifier((float)2.5, chalkPath, null, new IPathModifierListener()
		{
			@Override
