...
{
	public static void getPosition(float a, float b)
	{
		if (MainActivity.Flag == 1 && MainActivity.whiteChalk.collidesWith(MainActivity.rectangle1[1]))
		{
			MainActivity.touchPositionX = a;
			MainActivity.touchPositionY = b;
		} 
		...
		else if (MainActivity.Flag1[40] == 1 && MainActivity.whiteChalk.collidesWith(MainActivity.rectangle1[40]))
		{
			MainActivity.touchPositionX = a;
			MainActivity.touchPositionY = b;
		} 
		...
		{
			Chalk.chalkPath(MainActivity.touchPositionX, MainActivity.touchPositionY);
